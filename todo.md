...
- [x] Sync the local preview with the newest shared-project version
- [x] Execute and checkpoint every remaining stage in the authenticated JSON export plan
...
- [x] Checkpoint 10: Produce the required final handoff with checkpoint history
