...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      {/* Logo mark — an open book shape merging with a wind gust */}
      <motion.div
      ...
      >
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" aria-label="Name of the Words">
          {/* Book pages / wind motif */}
          <path
            d="M12 48 C12 24, 20 16, 32 12 C44 16, 52 24, 52 48"
          ...
          />
          <path
            d="M16 46 C16 28, 22 20, 32 16 C42 20, 48 28, 48 46"
      ...
      <motion.p
        ...
        className="text-sm text-muted-foreground tracking-wider mb-12 uppercase"
